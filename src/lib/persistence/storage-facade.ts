...
export const storage = {
  ...
  getUserByOAuthProvider: data.getUserByOAuthProvider,
  getUserByGithubId: data.getUserByGithubId,
  getUserByGitlabId: data.getUserByGitlabId,
  listOAuthProvidersByUserIds: data.listOAuthProvidersByUserIds,
